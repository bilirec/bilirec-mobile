...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    AppLocaleConfig.traditionalCode: {
      ...
      'antiSleepEnabledHint': '通知欄標題顯示 ⚡🛜 (WiFi) 或 ⚡🌐 (數據) 即代表防休眠已生效。',
      ...
      'maxConcurrentRecordingsDescription': '限制同時進行的錄製數量，避免裝置負載過高。',
    ...
    AppLocaleConfig.simplifiedCode: {
      ...
      'maxConcurrentRecordingsDescription': '限制同时进行的录制数量，避免设备负载过高。',
