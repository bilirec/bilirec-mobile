  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    AppLocaleConfig.traditionalCode: {
      ...
      'unexpectedStopRebootBody':
          '偵測到手機曾重新開機，錄製服務因此停止。\n\n建議開啟「開機自動恢復服務」（開啟後需再成功啟動一次服務才會生效）。部分國產手機系統會限制自動啟動；如果你使用國產手機系統，可參考設定教學。',
      ...
      'updateProgressDialogHint': '請保持 App 在前景，完成後會自動跳轉安裝。',
      ...
      'subscriptionListTransferDescription':
          '可匯入或匯出 bilirec 的 subscribes.db，方便搬移與備份訂閱列表。',
    ...
    AppLocaleConfig.simplifiedCode: {
      ...
      'unexpectedStopRebootBody':
          '检测到手机曾重新开机，录制服务因此停止。\n\n建议开启「开机自动恢复服务」（开启后需再成功启动一次服务才会生效）。部分国产手机系统会限制自启动；如果你使用国产手机系统，可参考设置教程。',
      ...
      'importSubscriptionListInvalidFile': '选取的文件无法读取，请重新选择。',
