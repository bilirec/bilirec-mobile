...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    AppLocaleConfig.traditionalCode: {
      ...
      'stoppingService': '正在停止 Bilirec 系統服務...',
      ...
      'settings': '打開服務啓動前設定',
      'serviceStartupSettingsTitle': '服務啓動前設定',
      ...
      'environmentSettingsWarning': '警告：不熟悉這些進階設定請勿調整。亂改可能造成手機發熱與耗電增加，並影響錄製效能；嚴重時後台可能被系統殺掉或限流。',
      ...
      'antiSleepDisabledHint': '此功能可能會增加電池消耗，請根據需要選擇性啟用',
    ...
    AppLocaleConfig.simplifiedCode: {
      ...
      'stoppingService': '正在停止 Bilirec 系统服务...',
      ...
      'settings': '打开服务启动前设置',
      'serviceStartupSettingsTitle': '服务启动前设置',
      ...
      'environmentSettingsWarning': '警告：不熟悉这些进阶设置请勿调整。乱改可能造成手机发热与耗电增加，并影响录制性能；严重时后台可能被系统杀掉或限流。',
      ...
      'antiSleepDisabledHint': '此功能可能会增加电池消耗，请根据需要选择性启用',
