...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    AppLocaleConfig.traditionalCode: {
      ...
      'outputPathPermissionDenied': '未授權存取所有檔案權限，無法選擇輸出路徑',
      ...
      'githubApiProxyTitle': 'GitHub API 反代',
      'githubApiProxyDescription':
          '用於檢查 App 與錄製服務是否有新版本。預設直連 GitHub。',
      ...
      'updatePolicyTitle': '更新策略',
      'updatePolicyDescription':
          '檢查 App 與錄製服務是否有新版本；若無法連上 GitHub，可調整下方反代。',
      ...
      'convertToMp4Description': '開啟後會在錄製完成時將 FLV/TS/fMP4 等源檔轉為 MP4，以提升播放相容性。\n注意：轉檔過程較耗電並會產生熱量。',
      'deleteSourceAfterConvertTitle': '轉檔後刪除原始檔',
      'deleteSourceAfterConvertDescription': '轉碼成功後刪除 FLV/TS/fMP4 等源檔，僅保留 MP4，可節省儲存空間。',
    ...
    AppLocaleConfig.simplifiedCode: {
      ...
      'outputPathPermissionDenied': '未授权访问所有文件权限，无法选择输出路径',
      ...
      'githubApiProxyTitle': 'GitHub API 反代',
      'githubApiProxyDescription':
          '用于检查 App 与录制服务是否有新版本。默认直连 GitHub。',
      ...
      'updatePolicyTitle': '更新策略',
      'updatePolicyDescription':
          '检查 App 与录制服务是否有新版本；若无法连上 GitHub，可调整下方反代。',
      ...
      'convertToMp4Description': '开启后会在录制完成时将 FLV/TS/fMP4 等源文件转为 MP4，以提升播放兼容性。\n注意：转换过程较耗电并会产生热量。',
      'deleteSourceAfterConvertTitle': '转换后删除原始文件',
      'deleteSourceAfterConvertDescription': '转码成功后删除 FLV/TS/fMP4 等源文件，仅保留 MP4，可节省存储空间。',
