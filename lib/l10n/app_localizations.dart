...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    AppLocaleConfig.traditionalCode: {
      ...
      'recordingRecoveryDurationTitle': '重試成功後的限時',
      'recordingRecoveryDurationDescription':
          '斷流後若重試成功並恢復錄製，限時計算可選擇從頭起算，或沿用開始錄製時的總時長。',
      'recordingRecoveryDurationPreserve': '保留',
      'recordingRecoveryDurationReset': '重置',
      'recordingRecoveryDurationPreserveHint': '限時仍從開始錄製起算，不延長。',
      'recordingRecoveryDurationResetHint': '限時從重試成功時重新計算。',
    ...
    AppLocaleConfig.simplifiedCode: {
      ...
      'recordingRecoveryDurationTitle': '重试成功后的限时',
      'recordingRecoveryDurationDescription':
          '断流后若重试成功并恢复录制，限时计算可选择从头起算，或沿用开始录制时的总时长。',
      'recordingRecoveryDurationPreserve': '保留',
      'recordingRecoveryDurationReset': '重置',
      'recordingRecoveryDurationPreserveHint': '限时仍从开始录制起算，不延长。',
      'recordingRecoveryDurationResetHint': '限时从重试成功时重新计算。',
